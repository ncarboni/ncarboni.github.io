...
- The project involves the creation of a IIIF-compliant digital library based on TEI/XML source files. It includes: (i) development or adaptation of a TEI/XML-to-IIIF transformation pipeline capable of processing annotations and serving images via IIIF-compliant image servers (e.g., Cantaloupe), (ii) implementation of a web interface incorporating IIIF image viewers (e.g., Universal Viewer) for edition browsing, and (iii) integration of edition metadata within the interface.
